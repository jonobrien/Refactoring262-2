...
/**
 * This class inherits from the player. This class identifies that the local
 * player is the second player in the game.
 * 
 * @author
 */
...
public class LocalPlayer extends Player
{
	 ...
	 * the opposite player to inform them that a draw has been offered. An
	 * actionEvent is generated to let the GUI know.
	 */
	 ...
	 * opposite player to inform them that the draw has been accepted. An
	 * actionEvent is generated to let the GUI know and endGame is called in
	 * theDriver.
	 */
	...
	public void endInDeclineDraw(Player player)
	{
		...
		JOptionPane.showMessageDialog(null, player.getName()
				...
				+ "\n\nClick OK to continue the game.", "Draw declined",
	 ...
	 * Fire off an action event to tell the GUI to display endMessage in a
	 * dialogue box. When the user clicks OK, call endGame in theDriver.
	 * 
	 * @param endMessage
