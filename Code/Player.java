...
/**
 * A class representation of the Player object. This object contains the methods
 * needed when one of the users clicks on one of the buttons within the GUI.
 * 
 * @author
 */
...
public abstract class Player
{
	 ...
	 * @param newRules
	 *            The rules used to validate moves.
	 * @param newDriver
	 *            Driver which will control this.
	 */
	...
	/**
	 * Make an istance of a Move that was just made and pass it to theRules by
	 * calling its validateMove method.
	 * 
	 * @param start
	 *            The starting spot of the move. The legal squares on the
	 *            checkers boardare numbered from 1 to 32, left to right, top to
	 *            bottom.
	 * @param end
	...
	/**
	 * This method is used for when a user has clicked on the "Quit" button on
	 * the GUI. It handles exiting the game.
	 * 
	 * @param the
	 *            player who quit
	...
	/**
	 * When the current player clicks the draw button, this method is called in
	 * the opposite player to inform them that a draw has been offered. This
	 * method is implemented differently for localPlayer and networkPlayer.
	 * 
	 * @param the
	 ...
	 * opposite player to inform them that the draw has been accepted. This
	 * method is implemented differently for localPlayer and networkPlayer.
	 * 
	 * @pre a game is in progress
	...
	/**
	 * Method is invoked if the other player declines a draw. It displays the
	 * dialog box for the decline of draw
	 */
	public abstract void endInDeclineDraw(Player player);

	/**
	 * Method that is invoked when the end of game conditions have been met. If
	 * they have been, this method is called in both players to notify them of
	 * this with a message. Implementation differs for local player and network
	 * player.
	 * 
	 * @param endMessage
