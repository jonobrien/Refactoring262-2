...
/**
 * This class is the system's Testing Kernel. For now it is hard coded,
 * sequential tests that will be performed.
 * 
 * It tests the system and how it responds to such things as basic moves/jumps,
 * illegal values, and illegal moves/jumps.
 * 
...
public class TestingKernel extends java.lang.Object
{
	 ...
	 * The main method.
	 * 
	 * Create a new instance of the driver and then create an instance of
	 * kernel, pass it that driver, and start the program from there.
	 * 
	 * @param args
	 ...
	 * 
	 * @param aFacade
	 *            The facade to manipulate in this program.
	 */
	...
	/**
	 * Test basic moves made by the checkers. This does not tests jumps or
	 * invalid moves.
	 * 
	...
	/**
	 * This method will attempt to make moves with out of bound values to ensure
	 * the system detects these without throwing an OutOfBounds Exception.
	 * 
	 * It will also test that the system detects making a move with the same
	...
	/**
	 * Tests for the following: A jump is possible. The player attempts to move
	 * elsewhere. System must not allow move and keep state unchanged.
	 * 
	 * @return Whether or not it passed the test.
	 */
	...
	/**
	 * When multiple jumps are present, this tests that they are forced and that
	 * the correct player keeps control of the game.
	 * 
	 * @return Whether or not it passed the test.
	 */
	public boolean testMultJumps()
	{
		...
		/**
		 * A high number of moves must be made for this to be set up. A diagram
		 * was made to figure out this sequence. It is:
		 * 
	...
	public boolean testInvalidMoves()
	{
		...
		System.out.println("Try move with " + "same start and end location.");
		...
		System.out.println("Now attempt to make a simple" + ", valid move.");
	...
	/**
	 * Tests the actions of the GUI and checks to see that both players may
	 * offer draws and accept/decline.
	 */
	...
	/**
	 * This method is for reporting. It outputs the name of the test and a
	 * Pass/Fail value along side of the test name.
	 * 
	 * @param passFail
	 *            Bool on whether or not test was passed.
	 * @param name
	 *            Name of test.
	 * @param tabs
	...
	/**
	 * This method is a generic way to put in place an artificial wait into the
	 * program. This allows for the program to have a delay without having to
	 * implement anything such as Runnable.
	 */
